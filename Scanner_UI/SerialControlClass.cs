...
namespace PhistonUI
{
    public sealed class SerialControlClass
    {
   
        // constructor
        private SerialControlClass()
        {
            //comPortStart();
        }

        //Singleton Instance
        private static readonly Lazy<SerialControlClass>
        lazy =    new Lazy<SerialControlClass>(() => new SerialControlClass());

        public static SerialControlClass Instance
        {
            get
            {
                return lazy.Value; 
        ...
        public async Task comPortStart()
        {
            ...
            // This will select the tera serial adapter cable
            ...
            try
            {
                ...
                string matchString = "VID_0403&PID_6001";
